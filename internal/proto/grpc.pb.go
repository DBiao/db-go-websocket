...
func init() { proto.RegisterFile("dgrpc/grpc.proto", fileDescriptor_30edbedfc0173ed4) }
...
// CommonServiceClient is the dclient API for CommonService service.
//
...
// CommonServiceServer is the dserver API for CommonService service.
